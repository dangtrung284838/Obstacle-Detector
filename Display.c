...
void Display_Init(void) {
    ...
    Write4Bit(0x20 >> 4, false);   // Set 4 bit operation
    Write8Bit(0x28, false);        // 2 line display, 5x8 font
    Write8Bit(0x0C, false); // Dipslay on,  cursor
...
void SetLine2(void){
	Write8Bit(0xC0, false);
}
void SetLine1(void){
	Write8Bit(0x80, false);
}
